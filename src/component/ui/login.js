...
export const Login = () => {
  ...
  const handleSignUp = () => {
    if (
      mobile !== "" &&
      /^[0-9]{10}$/.test(mobile) &&
      (signupUserType == "user" || signupUserType == "vendor")
    ) {
            ...
            <div className="px-5">
              ...
              <div className="row">
                <div className="col-6">
                  <button
                    type="button"
                    className={`btn choose-user-type-sign ${
                      signupUserType == "user" ? "active" : ""
                    }`}
                    onClick={() => setSignupUserType("user")}
                    disabled={sendOTP.isLoading || otpView ? true : false}
                  >
                ...
                <div className="col-6">
                  <button
                    type="button"
                    className={`btn choose-user-type-sign ${
                      signupUserType == "vendor" ? "active" : ""
                    }`}
                    onClick={() => setSignupUserType("vendor")}
                    disabled={sendOTP.isLoading || otpView ? true : false}
                  >
                    <span className="user-type-icon-sign">
                      <FaPersonChalkboard />
